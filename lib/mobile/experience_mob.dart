  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: <Widget>[
          const CustomizedText(text: "2020 - 2023", color: reddish, fontWeight: FontWeight.bold, letterSpacing: 3).animate().slide().fade(),
          const SizedBox(height: 20),
          const CustomizedText(text: "Experience", fontSize: 35, fontWeight: FontWeight.bold, letterSpacing: 2).animate().slide().fade(),
