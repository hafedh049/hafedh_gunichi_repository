            ...
            children: <Widget>[
              SizedBox(
                ...
                child: StepperListView(
                  shrinkWrap: true,
                  stepperData: <StepperItemData>[for (final Map<String, String> exp in experience.getRange(0, experience.length ~/ 2)) StepperItemData(content: exp)],
              ...
              SizedBox(
                ...
                child: StepperListView(
                  shrinkWrap: true,
                  stepperData: <StepperItemData>[for (final Map<String, String> exp in experience.getRange(experience.length ~/ 2, experience.length)) StepperItemData(content: exp)],
                  stepAvatar: (BuildContext context, dynamic value) => PreferredSize(preferredSize: const Size.fromRadius(15), child: Radio<bool>(value: true, groupValue: true, onChanged: (bool? value) => true, activeColor: reddish, hoverColor: hoverediconContainerColor)),
                  stepContentWidget: (BuildContext context, dynamic value) => EducationGlass(data: value.content),
                ),
              ),
